...
/**
 * Created by Emil.Allakhverdiev on 30.09.2016.
 */
public class CryptLab {
    ...
    public static byte[] encodeAES(byte[] message, String passphrase) throws NoSuchPaddingException, NoSuchAlgorithmException, InvalidKeyException, BadPaddingException, IllegalBlockSizeException {
    ...
    public static byte[] decodeAES(byte[] encodedMessage, String key) throws NoSuchPaddingException, NoSuchAlgorithmException, InvalidKeyException, BadPaddingException, IllegalBlockSizeException {
